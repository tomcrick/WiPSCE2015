...
South Wales)\footnote{As dicussed in further detail in
...
recognised by DEST, again throught the NSA, which has contracted
...
Wales. Thus the report of the ICT Steering Group formed an important
...
(the Welsh cultural dimension of the curriculum), along with the 2013
ICT review.

The publication of the Donaldson report (``{\emph{Successful
...
society. In some ways, there are a number of similarities to the
...
(and separating) digital competencies from the curriculum subject of
...
As we have seen in the previous section, Wales is at the cusp of
...
challanges of a devolved education system to address the specific
...
qualifications. Nevertheless, there are significant challenges
remaining, even if there is clarity around policy; in particularly,
...
essentially the entire teaching community of Wales. This is a the
...
Lead into Technocamps and teacher engagement...?
