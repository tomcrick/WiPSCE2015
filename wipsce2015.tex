...
primary reason for leaving~\cite{brown-et-al-toce2014}.
...
\subsection{The Technocamps Effect}\label{technoeffect}
...
% 2012 Technocamps/CAS conference
\begin{quotation}
...
\section{The Start of Reform in Wales}
...
Wales, there has been much focus on the use of technology in
...
and A-Levels). In January 2013, the Welsh Government's Minister for
...
computer science education more broadly, as evidenced by a Ministerial
speech from June 2012 (as quoted in Section~\ref{govrecog}).
...
digital competencies has been accepted, anything directly relating to
curriculum and qualifications had been delegated due to announcement
...
\section{Wales: A Nation Divided}\label{walesdivided}
...
Excellence~\cite{brown-et-al-toce2014,sentance-et-al-wipsce2014}. In
particular, in 2010 we jointly sent out an information pack to every
secondary school in Wales, after similar initiatives in England and
...
Despite the financial support of CAS (albeit primarily for supporting
activities in England and Scotland due to the funding sources)
receives, and the support it offers teachers in Wales, the successful
CAS model as developed in England has never proven successful in
Wales. For example, whilst CAS Hubs across the UK are generally run by
schools for schools, abiding to the principle of the teacher-led
...
An independent review of Technocamps activity in the Convergence
region of Wales carried out for Welsh Government estimates that 5\% of
Welsh secondary school-aged youths (ie, aged 11-19) in the convergence
area of Wales have engaged with Technocamps through Workshops, and
that more than a quarter of the secondary schools in the region have
established Technoclubs~\cite{Wavehill:2015}.  Furthermore, the new
...
to Technocamps Workshops and follow-up engagement. While there is
...
continue to develop -- through direct involvement of and engagement
with Technocamps.
