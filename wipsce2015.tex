...
and other stakeholders for being dull and unchallenging and
...
secondary school pupils find ICT unstimulating.
The Wolf report~\cite{Wolf:2011} further notes that
the undemanding nature of, e.g. ICT qualifications in secondary schools
is readily exploited by the schools: due to a high league table
weaighting associated with vocational qualifications, easily-achieved
high results in ICT offer a boost to a school's league table position.
